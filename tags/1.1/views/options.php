<div class="category-head">
		...
		<tr>
			<td width="80px">
				<span class="category-logo"><?php echo opicltq_icon_logo('options.png',array('width'=>'80px')) ?></span>
				</td>
			<td>
...
echo $LTQHtml -> Input('select', array('name' => 'cronjobtime', 'options' => $timeList, 'label' =>$this->getLang('label-import_data_time')));
echo $LTQHtml->Input('text',array('name' => 'source', 'label' => $this->getLang('label-source')));
?>