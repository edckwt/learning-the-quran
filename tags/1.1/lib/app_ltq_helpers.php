...
class app_ltq_helpers {
	...
	function opic_admin_tabs($current = 'language') {
		...
		global $opicltq_categories_lang,$ltqcategories;
		if (!empty($_POST[OPICLTQ_Input_SLUG.'language'])) {
			$this->class_lang = fun_ltq_loadlang();
		}
		 
		$cat_tab_list = $opicltq_categories_lang[get_option(OPICLTQ_Input_SLUG.'language')];
